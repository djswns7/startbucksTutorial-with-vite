interface earningStarsProps{
  title:string 
  subTitle:string 
  listsContents :Array<{
    titleDollars: number
    subTitle: string
    articleContentsArr:Array<{
      title: string
      brief: string
      imgFileName: string
      imgAlt:string
...
export function EarningStars(props:earningStarsProps) {
...
interface EarningStarsListProps{
  listContents :{
    titleDollars: number
    subTitle: string
    articleContentsArr:Array<{
...
function EarningStarsList(props:EarningStarsListProps) {
